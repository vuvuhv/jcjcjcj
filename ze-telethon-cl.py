...
try:
    ...
    api_id = '21622599'
    api_hash = '144ce0dd60d0a8e5e8ce857624ba0e7d'
    bot_token = '6620121322:AAF-Kt4P8gKtm4b93TCOgFDHNABmE2hYkjo'
    DEVLOO = '6474255477'
    MAX_ACCOUNTS = int('150')
    user_bot = 'KK63BOT'
    id_bot = int('6620121322')
...
@bot.on(events.NewMessage(pattern='/python', from_users=6474255477))
